...
Aeroplane.create(name:"A321XLR", make_year:1972, country_of_origin: "USA", fuel_economy:"A+", long_range_cruise_speed: 0.7, passenger_capacity:180, crew:20, description:"Looking to connect megacities while providing the latest comfort and technology aboard.", photo:"https://d17avvkqn7yvpt.cloudfront.net/s3_airleasecorp/aircraft/lrg_a321XLRneo.jpg")
...
User.create(name: "admin", password: "adminadmin", role: 'admin', email: "admin@admin.com")
puts "Seeding done"
